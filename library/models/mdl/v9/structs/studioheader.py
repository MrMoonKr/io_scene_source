...
class StudioHeader:
    ...
    def from_buffer(cls, buffer: Buffer):
        ...
        assert version in [9, 10], f'MDL version {version} are not supported by GoldSrc importer'
        ...
        return cls(version, name, file_size, eye_pos, min, max, bbmin, bbmax, flags, *buffer.read_fmt('24I'))
