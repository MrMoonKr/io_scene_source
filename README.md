[![Blender](https://img.shields.io/badge/Blender->=_4.5-orange?logo=blender&logoColor=white)](https://www.blender.org/download)
...
# SourceIO
SourceIO is a Blender(4.0+) addon for importing source engine textures/models/maps
